...
<div class="buttonbox col-7 col-sm-2 position-fixed ">
    ...
    <div class="pacustom btn-group-vertical container-fluid  align-self-center">
        <a href="dashboard.php" class="text-dec text-dark "><button type="button" class="navBtnGp1 dshbtn1  col-12 btn btn-light   mt-3 overflow-hidden ">
        ...
        <a href="bookInfo.php" class="text-dec text-dark"><button type="button" class="navBtnGp1 dshbtn  col-12 btn btn-light  overflow-hidden mt-3 text-nowrap ">
                <div class="row justify-content-center">
        ...
        <a href="authorInfo.php" class="text-dec text-dark"><button type="button" class="navBtnGp1 dshbtn col-12 btn btn-light overflow-hidden mt-3 text-nowrap text-center">
                <div class="row justify-content-center">
                    <div class="icons col-1 ">
        ...
        <a href="userInfo.php" class="text-dec text-dark"><button type="button" class="navBtnGp1 dshbtn  col-12 btn btn-light overflow-hidden mt-3 text-nowrap text-center">
                <div class="row justify-content-center">
                    <div class="icons col-1 ">
        ...
        <a href="orderInfo.php" class="text-dec text-dark"><button type="button" class="navBtnGp1 dshbtn  col-12 btn btn-light overflow-hidden mt-3 text-nowrap text-center">
                <div class="row justify-content-center">
                    <div class="icons col-1 ">
        ...
        <a href="community.php" class="text-dec text-dark"><button type="button" class="navBtnGp1 dshbtn  col-12 btn btn-light overflow-hidden mt-3 text-nowrap text-center">
                <div class="row justify-content-center">
                    <div class="icons col-1 ">
        ...
        <a href="setting.php" class="text-dec text-dark"><button type="button" class="navBtnGp1 dshbtn  col-12 btn btn-light text-break mt-3 text-nowrap text-center">
                <div class="row justify-content-center">
                    <div class="icons col-1 ">
