...
$sql = $dbconnect->prepare(
    "SELECT  m_book.id,m_book.book_image,m_book.book_name,m_book.book_price,m_book.book_pages,m_book.book_size,m_book.book_established,m_book.book_description,m_book.rating,m_author.author_name,m_category.category_name FROM m_book
